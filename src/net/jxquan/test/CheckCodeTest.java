...
import net.jxquan.util.HttpClientHelper;

public class CheckCodeTest {
	public static void sendCheckCode(int checkCode,String mobile) {
		 ...
		 */
		para.put("p1", CheckCodeUtils.getCheckCode().toString());
		try {
			System.out.println(
	...
	@Test
	public void fun(){
		CheckCodeUtils.sendCheckCode(CheckCodeUtils.getCheckCode(),"18829211793");
	}
